...
#ifndef SURREALDB_LOCAL_WRAPPER_IOS_SWIFT_H
#define SURREALDB_LOCAL_WRAPPER_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="surrealdb_local_wrapper_ios",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
